	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
                            <h1><a href="index.jsp"><span></span><img src="images/logo.jpeg" height="100" width="170"></a></h1>
			</div>
	...
	<div class="banner">
		...
		<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
                                                    <h4><a href="mens.jsp">  Mens </a>,<a href="womens.jsp"> Womens</a> & <a href="kids.jsp">Kids</a></h4>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						<img src="images/LP1.jpeg" alt=" " class="img-responsive" />
						<div class="mask">
							<h4><a href="electronic.jsp">Electronics</a> &<a href="books.jsp"> Books</a></h4>
							
						</div>
					</div>
					<h4>Acer aspire laptop</h4>
					<ol>
				...
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4><a href="home.jsp">Home</a> &<a href="furnitures.jsp"> Furniture</a></h4>
			...
			<div class="wthree_banner_bottom_left_grid_sub1">
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="images/TT.jpeg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="images/PP.jpeg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="images/GK.jpeg" alt=" " class="img-responsive" />
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list">
					<li><a href="pet.html">Mens </a></li>
					<li><a href="frozen.html">Womens </a></li>
					<li><a href="kitchen.html">Electronics</a></li>
					<li><a href="products.html">Kids </a></li>
					<li><a href="household.html">Home</a></li>
                                        <li><a href="household.html">furnitures</a></li>
                                        <li><a href="household.html">Books</a></li>
				</ul>
			</div>
			<div class="col-md-3 w3_footer_grid">
				<h3>twitter posts</h3>
