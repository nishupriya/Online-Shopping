	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				<h3 class="w3l_fruit">Search Results</h3>
				<div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
                                    <h6><% out.println("Searched for "+query); %></h6>
                                    <%
                                        Statement stmt = con.createStatement();//creating a statement reference requestuired to execute a query
                                        String q1 = "select pid from products where lower(pname) like lower('%"+query+"%') OR lower(section) like lower('%"+query+"%') OR lower(category) like lower('%"+query+"%') OR lower(description) like lower('%"+query+"%')";
