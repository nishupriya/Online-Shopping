				...
				<h3 class="w3l_fruit">My Cart</h3>
                                 ...
                                 <center>
                                            ...
                                            while(rs.next())
                                            {
                                                ...
                                                %>
                                                    <tr>
                                                        ...
                                                        <td><a href="product_details.jsp?pid=<%=pid %>"> <img src="<%=ig %>" height="70" width="70" /> </a> </td>

                                                        <td><a href="product_details.jsp?pid=<%=pid %>"><% out.print(pname); %></a></td>
                                                        <td><% out.print(desc); %></td>
                                                        <td><% out.print(prc); %></td>
                                                        <td><% out.print(qty); %></td>
                                                        <td><% out.print(amount); %></td>
                                                        <td><form method="get" action="RemoveFromCart">
                                    ...
                                    <form action="BuyNow" method="get">
                                        <br/><br/><br/>
                                        Enter Delivery Address : <input type="text" name="address" />
