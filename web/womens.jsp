			...
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
                                    ...
                                    <%
                                        ...
                                        String q1 = "select pid from products where section='womens' and category='1' and rownum<=10";
					...
					<div class="clearfix"> </div>
                                ...
                                <div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
                                    ...
                                    <%
                                        ...
                                        q1 = "select pid from products where section='womens' and category='2' and rownum<=10";
					...
					<div class="clearfix"> </div>
                                ...
                                <div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
                                    ...
                                    <%
                                        stmt = con.createStatement();//creating a statement reference requestuired to execute a query
                                        q1 = "select pid from products where section='womens' and category='3' and rownum<=10";
                                        rs = stmt.executeQuery(q1);//if query runs successfully it gives a +ve value
