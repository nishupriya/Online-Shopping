...
<html>
<head>
<title>Online Shopping-FirstBuy | Sign In & Sign Up :: </title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="index.jsp"><img src="images/logo.jpeg" height="100" width="160"></a></h1>
			</div>
					...
					<form action="Registration" method="get">
					  ...
					  Security Question
						...
						<option value="Birthday">Birthday</option>
                                          ...
                                          <input type="text" name="sqans" placeholder="Security Answer" required=" ">
					  <input type="submit" value="Register">
					</form>
				  </div>
				  <div class="cta"><a href="forgot password.html">Forgot your password?</a></div>
				</div>
			</div>
			<script>
