...
public final class mens_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      Statement stmt3 = con.createStatement();//creating a statement reference requestuired to execute a query
      String q3 = "select * from customer where email='"+email+"'";
      ResultSet rs3 = stmt3.executeQuery(q3);//if query runs successfully it gives a +ve value
                                            
      if(rs3.next())
      {
          name = rs3.getString("email");
      }
      String pname = "";
      Float prc = (float)0;
      String img = "";
 ...
 out.println(name); 
      ...
      out.write("\t\t\t\t<h3 class=\"w3l_fruit\">MENS</h3>\n");
      ...
      out.write("                                    ");
                                        ...
                                        String q1 = "select pid from products where section='mens' and category='1' and rownum<=10"
                                                + "";
 ...
 out.print(prc + prc*.2); 
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("                                <div class=\"w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg\">\n");
      out.write("                                    <h6>Footwears</h6>\n");
      out.write("                                    ");

                                        stmt = con.createStatement();//creating a statement reference requestuired to execute a query
                                        q1 = "select pid from products where section='mens' and category='2' and rownum<=10";
 ...
 out.print(prc + prc*.2); 
      ...
      out.write("                                    ");
                                        ...
                                        stmt = con.createStatement();//creating a statement reference requestuired to execute a query
                                        q1 = "select pid from products where section='mens' and category='3' and rownum<=10";
                                        rs = stmt.executeQuery(q1);//if query runs successfully it gives a +ve value
