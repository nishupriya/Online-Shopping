    ...
    public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
    {
        ...
        */
        ...
        try
        {
            ...
            String q1 = "delete from products where pid='"+pid+"'";
            int x = stmt.executeUpdate(q1);//if query runs sucessfully it gives a +ve value
            if(x>0)   //user exist
            {
                  pw1.println("Delete successful. Click <a href=\"admin.jsp\">here</a> to go to admin page.<br/>Click <a href=\"View Product.jsp\">here</a> to go to All products page.");
